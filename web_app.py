...
def start_bot():
    ...
    cfg = load_config()
    log_buffer = ["🚀 New session started — all counters reset to 0."]
    ...
    bot_thread.start()
    append_log("🚀 Automation engine running...", "SUCCESS")
...
def google_login():
    ...
    append_log("🌐 Opening Chrome for Google Sign-in...", "INFO")
...
def manual_login():
    ...
    threading.Thread(target=worker, daemon=True).start()
    append_log("💻 Opening Chrome for email login...", "INFO")
...
if __name__ == "__main__":
    print("=" * 55)
    print("  🚀 Naukri Auto-Applier Pro — Web Application")
